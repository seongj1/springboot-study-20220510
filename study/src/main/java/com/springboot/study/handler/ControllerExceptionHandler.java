...
public class ControllerExceptionHandler {
	...
	@ExceptionHandler(CustomValidationApiException.class) // 예외가 발생했을 때 낚아채는 어노테이션
	public ResponseEntity<?> validationApiException(CustomValidationApiException e){ // 잡아온 클래스를 자료형으로 하는 변수를 매개변수로 받는다.
